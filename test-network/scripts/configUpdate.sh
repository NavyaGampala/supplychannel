...
#  peer channel fetch config config_block.pb -o orderer2.example.com:7051 --ordererTLSHostnameOverride orderer2.example.com -c $CHANNEL --tls --cafile "$ORDERER_CA"
#  peer channel fetch config config_block.pb -o orderer3.example.com:7052 --ordererTLSHostnameOverride orderer3.example.com -c $CHANNEL --tls --cafile "$ORDERER_CA"
