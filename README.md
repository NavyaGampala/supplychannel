Generating certifiates using cryptogen:
...
configtxgen -profile TwoOrgsApplicationGenesis1 -outputBlock ./channel-artifacts/${CHANNEL_NAME}.block -channelID $CHANNEL_NAME
...
configtxgen -profile TwoOrgsApplicationGenesis3 -outputBlock ./channel-artifacts/${CHANNEL_NAME}.block -channelID $CHANNEL_NAME
cp ../config/core.yaml ./configtx/.
